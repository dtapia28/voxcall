...
declare module 'voximplant-websdk' {
    ...
    export { OperatorACDStatuses, LoginTokens, VideoFlags, LogRecord, CallstatsIoParams, QueueTypes, } from 'voximplant-websdk/Structures';
...
declare module 'voximplant-websdk/Call/EndPoints/Endpoint' {
    ...
    export class Endpoint extends EventTarget<EndpointEvents> {
            ...
            /**
                ...
                * @param call
                */
            notifyAboutCreation(call: Call): void;
            /**
                * @hidden
                * @return {string}
                * @private
...
declare module 'voximplant-websdk/Structures' {
    ...
    /**
        ...
        *  For detailed information of ACD concept see the [Modules.ACD](/docs/introduction/introduction_to_voximplant/capabilities_and_components/calling_capabilities/acd) documentation and the [appropriate HowTo's](/docs/howtos/acd).
        */
...
declare module 'voximplant-websdk/PeerConnection/PeerConnection' {
    ...
    export abstract class PeerConnection {
            ...
            /**
                ...
                * @param {boolean} isEndedEvent
                */
            replaceVideoTrack(track: MediaStreamTrack, isEndedEvent: boolean): void;
            protected abstract _replaceVideoTrack(track: MediaStreamTrack, isEndedEvent: boolean): void;
